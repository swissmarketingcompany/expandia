                ...
                <div class="container mx-auto container-padding">
                    <div class="grid lg:grid-cols-[0.72fr_0.28fr] gap-10 items-start">
                        <div class="max-w-4xl min-w-0" style="min-width: 0; max-width: 100%;">
                            ...
                            ${paragraph(`Use this guide as a working agenda for a ${market.city} AI automation discussion. Bring one current workflow example, one recent customer or internal request, one source document, and one metric that shows the cost of the manual process. That gives the team enough context to decide whether the workflow is ready for AI support.`)}
                            ${paragraph(`The next step is to choose a narrow pilot. For ${market.city}, that usually means selecting one workflow from the examples above, defining the current baseline, naming the process owner, and agreeing where human review is required. A pilot with clear boundaries is easier to test, safer to launch, and more useful for leadership than a broad AI initiative with no measurable output.`)}
